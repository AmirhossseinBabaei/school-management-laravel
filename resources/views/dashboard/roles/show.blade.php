...
@section('title', 'مشاهده نقش | سیستم مدیریت مدرسه')
                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                    <div>
                        <h3 class="mb-2 gradient-text fw-bold">
                            <i class="fa-solid fa-eye me-2"></i>مشاهده نقش
                        </h3>
                        <p class="text-muted mb-0">جزئیات نقش: <span class="fw-semibold text-primary">{{ $data['role']->name }}</span></p>
                    </div>
                    <div class="d-flex gap-2">
                        <a href="{{ route('dashboard.roles.edit', $data['role']->id) }}" class="btn bg-warning btn-pill">
                    ...
                    <div class="card glass-effect border-0 shadow-lg animate__animated animate__fadeInUp" style="animation-delay: 0.2s;">
                        <div class="card-header glass-effect border-0">
                            <h5 class="mb-0 gradient-text fw-bold">
                                <i class="fa-solid fa-info-circle me-2"></i>اطلاعات نقش
                            </h5>
                        </div>
                        <div class="card-body p-4">
                            <div class="info-card">
                                <div class="info-item">
                                    ...
                                    <div class="info-value">{{ $data['role']->name }}</div>
                                </div>
                                ...
                                <div class="info-item">
                                    ...
                                    <div class="info-value">
                                        <span class="badge {{ $data['role']->status == 'فعال' ? 'bg-success' : 'bg-danger' }} rounded-pill">
                                            <i class="fa-solid fa-check me-1"></i>{{ $data['role']->status }}
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="info-item">
                                    ...
                                    <div class="info-value">{{ $data['role']->created_at ? $data['role']->created_at : 'نامشخص' }}</div>
                                </div>
                                ...
                                <div class="info-item">
                                    ...
                                    <div class="info-value">{{ $data['role']->updated_at ? $data['role']->updated_at : 'نامشخص' }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card glass-effect border-0 shadow-lg animate__animated animate__fadeInUp" style="animation-delay: 0.3s;">
                        ...
                        <div class="card-body p-4">
                            <div class="d-grid gap-3">
                                ...
                                <a href="{{ route('dashboard.roles.create') }}" class="btn bg-success btn-pill">
                                    <i class="fa-solid fa-plus me-2"></i>ایجاد نقش جدید
                                </a>
                                <a href="{{ route('dashboard.roles.index') }}" class="btn bg-primary btn-pill">
