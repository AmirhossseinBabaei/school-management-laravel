...
@section('title', 'ایجاد نقش جدید | سیستم مدیریت مدرسه')
                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                    <div>
                        <h3 class="mb-2 gradient-text fw-bold">
                            <i class="fa-solid fa-user-shield me-2"></i>ایجاد نقش جدید
                        </h3>
                        <p class="text-muted mb-0">افزودن نقش جدید به سیستم</p>
                    </div>
            ...
            <div class="card glass-effect border-0 shadow-lg animate__animated animate__fadeInUp" style="animation-delay: 0.2s;">
                <div class="card-header glass-effect border-0">
                    <h5 class="mb-0 gradient-text fw-bold">
                        <i class="fa-solid fa-plus me-2"></i>فرم ایجاد نقش
                    </h5>
                </div>
                    ...
                    <form method="post" action="{{ route('dashboard.roles.store') }}">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <input type="text" name="name" class="form-control" placeholder="مثال: مدیر، کاربر، ادمین" value="{{ old('name') }}">
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <select name="status" class="form-select">
                                    ...
                                    <option value="inactive" {{ old('status') == 'inactive' ? 'selected' : '' }}>غیر فعال</option>
                                </select>
                            </div>

                            <div class="col-12">
                                <div class="d-flex gap-3 justify-content-end">
                                    <a href="{{ route('dashboard.roles.index') }}" class="btn bg-danger btn-pill">
