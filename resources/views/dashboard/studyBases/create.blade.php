...
@section('title', 'ایجاد پایه تحصیلی جدید | سیستم مدیریت مدرسه')
                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                    <div>
                        <h3 class="mb-2 gradient-text fw-bold">
                            <i class="fa-solid fa-layer-group me-2"></i>ایجاد پایه تحصیلی جدید
                        </h3>
                        <p class="text-muted mb-0">افزودن پایه تحصیلی جدید به سیستم</p>
                    </div>
            ...
            <div class="card glass-effect border-0 shadow-lg animate__animated animate__fadeInUp" style="animation-delay: 0.2s;">
                <div class="card-header glass-effect border-0">
                    <h5 class="mb-0 gradient-text fw-bold">
                        <i class="fa-solid fa-plus me-2"></i>فرم ایجاد پایه تحصیلی
                    </h5>
                </div>
                <div class="card-body p-4">
                    <form method="post" action="{{ route('dashboard.studyBases.store') }}">
                        @csrf
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <input type="text" name="name" class="form-control" placeholder="مثال: اول، دوم، سوم" value="{{ old('name') }}">
                            </div>
                            ...
                            <div class="col-12">
                                <div class="d-flex gap-3 justify-content-end">
                                    ...
                                    <button type="submit" class="btn bg-success btn-pill">
                                        <i class="fa-solid fa-save me-2"></i>ایجاد پایه تحصیلی
                                    </button>
                                </div>
                            </div>
                        </div>
