...
@section('title', 'ویرایش دانش آموز جدید | سیستم مدیریت مدانش آموزه')
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
            <div>
                <h3 class="mb-2 gradient-text fw-bold">
                    <i class="fa-solid fa-user-shield me-2"></i>ویرایش دانش آموز جدید
                </h3>
    ...
    <div class="card glass-effect border-0 shadow-lg animate__animated animate__fadeInUp" style="animation-delay: 0.2s;">
        <div class="card-header glass-effect border-0">
            <h5 class="mb-0 gradient-text fw-bold">
                <i class="fa-solid fa-plus me-2"></i>فرم ویرایش دانش آموز
            </h5>
        </div>
        <div class="card-body p-4">
            <form method="post" action="{{ route('dashboard.students.update', $data['student']->id) }}">
                @csrf
                @method('put')
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <select name="user_id" class="form-control">
                            <option value="{{ $data['student']->user->id }}">{{ $data['student']->user->first_name }}-{{ $data['student']->user->last_name  }}/
                    ...
                    <div class="col-12">
                        ...
                        <select name="study_field_id" class="form-control">
                            <option value="{{ $data['student']->studyField->id }}">{{ $data['student']->studyField->name }}</option>
                    ...
                    <div class="col-12">
                        ...
                        <select name="study_base_id" class="form-control">
                            <option value="{{ $data['student']->studyBase->id }}">{{ $data['student']->studyBase->name }}</option>
                    ...
                    <div class="col-12">
                        ...
                        <select name="class_id" class="form-control">
                            <option value="{{ $data['student']->classRoom->id }}">{{ $data['student']->classRoom->name }}</option>
                    ...
                    <div class="col-12">
                        ...
                        <select name="school_id" class="form-control">
                            <option value="{{ $data['student']->school->id }}"> {{ $data['student']->school->name }}</option>
                    ...
                    <div class="col-12">
                        <div class="d-flex gap-3 justify-content-end">
                            ...
                            <input class="btn bg-success btn-pill" value="ویرایش دانش آموز" type="submit">
                        </div>
                    </div>
                </div>
            </form>
