...
@section('title', 'ویرایش ترم | سیستم مدیریت مدرسه')
    ...
    <div class="hero glass-effect p-4 mb-4 animate__animated animate__fadeInUp"
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
            <div>
                ...
                <p class="text-muted mb-0">ویرایش اطلاعات ترم: <span
                        class="fw-semibold text-primary">{{ $data['term']->name }}</span></p>
            </div>
    ...
    <div class="card glass-effect border-0 shadow-lg animate__animated animate__fadeInUp"
        ...
        <div class="card-header glass-effect border-0">
            <h5 class="mb-0 gradient-text fw-bold">
                <i class="fa-solid fa-edit me-2"></i>فرم ویرایش ترم
            </h5>
        </div>
        <div class="card-body p-4">
            <form action="{{ route('dashboard.terms.update', ['term' => $data['term']->id]) }}" method="post">
                @csrf
                @method('put')
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" name="name" class="form-control"
                               value="{{ old('name', $data['term']->name) }}" placeholder="مثال: نوبت اول">
                    </div>

                    <div class="col-12">
                        <label class="form-label fw-semibold">
                            <i class="fa-solid fa-tag me-2 text-primary"></i>مدرسه
                        </label>
                        <select name="school_id" class="form-control">
                            <option value="{{ $data['term']->school->id }}">{{ $data['term']->school->name }}</option>
                    ...
                    <div class="col-12">
                        ...
                        <div class="persian-datepicker">
                            <p class="text-white text-left col-12"> تاریخ ثبت شده : {{ $data['term']->from_date  }}  </p>
                            <input type="text" id="from-date-picker" name="from_date"
                                   class="persian-datepicker-input form-control"
                                   placeholder="روز/ماه/سال" value="{{ $data['term']->from_date  }}" readonly>
                    ...
                    <div class="col-12">
                        ...
                        <div class="persian-datepicker">
                            <p class="text-white text-left col-12"> تاریخ ثبت شده : {{ $data['term']->to_date  }}  </p>
                            <input type="text" id="to-date-picker" name="to_date"
                                   class="persian-datepicker-input form-control"
                                   placeholder="روز/ماه/سال" value="{{ $data['term']->to_date  }}" readonly>
                            <i class="fa-solid fa-calendar persian-datepicker-icon"></i>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="d-flex gap-3 justify-content-end">
                            ...
                            <button type="submit" class="btn bg-warning btn-pill">
                                <i class="fa-solid fa-save me-2"></i>بروزرسانی ترم
                            </button>
                        </div>
                    </div>
                </div>
