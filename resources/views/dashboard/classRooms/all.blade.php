                        ...
                        <tr class="animate__animated animate__fadeInUp" style="animation-delay: {{ $key * 0.1 }}s;">
                            ...
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div>
                                        <div class="fw-semibold">{{ $classRoom->study_field->name ?? 'نامشخص' }}</div>
                            ...
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div>
                                        <div class="fw-semibold">{{ $classRoom->study_base->name ?? 'نامشخص' }}</div>
                            ...
                            <td class="text-center">
                                <div class="btn-group" role="group">
                                    ...
                                    <button class="btn btn-sm btn-danger delete-btn"
                                            data-id="{{ $classRoom->id }}" title="حذف">
    ...
    <script>
        ...
        document.addEventListener('click', function(e) {
            if (e.target.closest('.delete-btn')) {
                e.preventDefault();
                if (confirm('آیا مطمئن هستید که می‌خواهید این کلاس درس را حذف کنید؟')) {
                    const classRoomId = e.target.closest('.delete-btn').dataset.id;
                    const url = "{{ route('dashboard.classRooms.destroy', ':id') }}".replace(':id', classRoomId);
